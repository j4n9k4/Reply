        ...
        LazyColumn(
            ...
            item {
                ...
                ReplyEmailDetailsCard(
                    ...
                    modifier = if(isFullScreen){Modifier.navigationBarsPadding()}
                    else {Modifier.padding(horizontal = dimensionResource(R.dimen.detail_card_outer_padding_horizontal))}
                )
            }
        }
    }
...
fun ReplyDetailsPreview()
{
    ...
    ReplyTheme {
        ReplyDetailsScreen(replyUiState, false, {})
    }
}